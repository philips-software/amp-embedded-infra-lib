...
function(emil_add_test target)
    ...
    if (NOT ${exclude})
        if (EMIL_ENABLE_MUTATION_TESTING)
            ...
            target_compile_definitions(${target} PRIVATE EMIL_MUTATION_TESTING)
            target_sources(${target} PRIVATE ${CMAKE_CURRENT_FUNCTION_LIST_DIR}/MutationTestingTimeoutGuard.cpp)
        else()
