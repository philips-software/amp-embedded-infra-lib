...
namespace std
{
    ...
    public:
        ...
        explicit thread(F&& f, Args&&... args)
        {
            ...
            UINT result = tx_thread_create(threadId.threadHandle, "", &ThreadFunction, reinterpret_cast<ULONG>(threadData), threadData->stack, stackSize, priority, priority, TX_NO_TIME_SLICE, TX_AUTO_START);
