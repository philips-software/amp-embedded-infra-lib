...
namespace services
{
    ...
    infra::SharedPtr<MethodDeserializer> ServiceForwarderBase::StartMethodImpl(uint32_t serviceId, uint32_t methodId, uint32_t size, const EchoErrorPolicy& errorPolicy)
    {
