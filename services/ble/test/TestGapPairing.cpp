...
namespace services
{
    ...
    {
        return x.macAddress == arg.macAddress && x.addressType == arg.addressType && infra::ContentsEqual(x.temporary, arg.temporaryKey) && infra::ContentsEqual(x.randomData, arg.randomData) && infra::ContentsEqual(x.confirmData, arg.confirmData);
    }
    ...
    TEST_F(GapPairingDecoratorTest, forward_all_events_to_observers)
    {
        ...
        EXPECT_CALL(gapPairingObserver, OutOfBandDataGenerated(OutOfBandDataContentsEqual(GapPairingObserver::OutOfBandData{ hal::MacAddress(), GapDeviceAddressType::publicAddress, temporary, random, confirm })));
        ...
        gapPairing.NotifyObservers([this](GapPairingObserver& obs)
            {
                ...
                obs.OutOfBandDataGenerated(GapPairingObserver::OutOfBandData{ hal::MacAddress(), GapDeviceAddressType::publicAddress, temporary, random, confirm });
            });
    }
