...
TEST_F(GattClientCharacteristicTest, should_enable_notification_characteristic_and_callback)
{
    ...
    EXPECT_CALL(operations, EnableNotification(testing::Ref(characteristic), ::testing::_)).WillOnce([](const services::GattClientCharacteristicOperationsObserver&, infra::Function<void(uint8_t)> onDone)
        {
            onDone(result);
        });
...
TEST_F(GattClientCharacteristicTest, should_disable_notification_characteristic_and_callback)
{
    ...
    EXPECT_CALL(operations, DisableNotification(testing::Ref(characteristic), ::testing::_)).WillOnce([](const services::GattClientCharacteristicOperationsObserver&, infra::Function<void(uint8_t)> onDone)
        {
            onDone(result);
        });
...
TEST_F(GattClientCharacteristicTest, should_enable_indication_characteristic_and_callback)
{
    ...
    EXPECT_CALL(operations, EnableIndication(testing::Ref(characteristic), ::testing::_)).WillOnce([](const services::GattClientCharacteristicOperationsObserver&, infra::Function<void(uint8_t)> onDone)
        {
            onDone(result);
        });
...
TEST_F(GattClientCharacteristicTest, should_disable_indication_characteristic_and_callback)
{
    ...
    EXPECT_CALL(operations, DisableIndication(testing::Ref(characteristic), ::testing::_)).WillOnce([](const services::GattClientCharacteristicOperationsObserver&, infra::Function<void(uint8_t)> onDone)
        {
            onDone(result);
        });
