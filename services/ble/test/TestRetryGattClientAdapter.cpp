...
TEST_F(RetryGattClientCharacteristicsOperationsTest, should_call_write_characteristic)
{
    ...
    EXPECT_CALL(adapter, Write(testing::Ref(characteristicsOperationsObserver), infra::ByteRangeContentsEqual(data), testing::_))
...
TEST_F(RetryGattClientCharacteristicsOperationsTest, should_call_write_without_response_characteristic)
{
    ...
    EXPECT_CALL(adapter, WriteWithoutResponse(testing::Ref(characteristicsOperationsObserver), infra::ByteRangeContentsEqual(data), testing::_))
        .WillOnce(testing::SaveArg<2>(&onWriteDoneMock));
...
TEST_F(RetryGattClientCharacteristicsOperationsTest, should_forward_indication_received)
{
    ...
    EXPECT_CALL(stackUpdateObserver, IndicationReceived(handle, testing::ElementsAreArray(data), testing::_));
