...
namespace services
{
    ...
    public:
        ...
        MOCK_METHOD(void, Write, (const GattClientCharacteristicOperationsObserver& characteristic, infra::ConstByteRange data, const infra::Function<void(OperationStatus)>& onDone), (override));
