...
namespace services
{
    ...
    public:
        ...
        // Implementation of GattClientIndicationNotification
        ...
        MOCK_METHOD(AttAttribute::Handle&, CharacteristicHandle, ());
    ...
    public:
         ...
         MOCK_METHOD(void, StartDescriptorDiscovery, (const GattCharacteristic& characteristic), (override));
    };
}
