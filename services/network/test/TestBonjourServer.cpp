...
public:
    ...
    void ReConstructIPv6()
    {
        ...
        infra::ReConstruct(server, factory, multicast, "instance", "service", "type", infra::none, std::make_optional(services::IPv6Address{ 1, 2, 3, 4, 5, 6, 7, 8 }), 1234, text);
        ExecuteAllActions();
        expectLeave = [this]()
        {
    ...
    services::BonjourServer server{ factory, multicast, "instance", "service", "type", std::make_optional(services::IPv4Address{ 1, 2, 3, 4 }), infra::none, 1234, text };
