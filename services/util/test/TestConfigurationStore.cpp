...
public:
    std::array<uint8_t, 20> data{ { 0x08, 0xa9, 0x9b, 0x3e, 0xa5, 0x0b, 0x15, 0xb9, 6, 0, 0, 0, 0, 1, 2, 3, 4, 5, 6, 7 } };
...
TEST_F(FactoryDefaultConfigurationStoreTest, failed_factory_default_results_in_OnLoadFactoryDefault)
{
    ...
    EXPECT_CALL(*this, OnLoadFactoryDefault()).WillOnce(testing::Invoke([this]() { configurationStore.Configuration().data = 5; }));
...
public:
    const std::array<uint8_t, 32> factoryDefault{ { 
            0xfb, 0x76, 0x16, 0x1c, 0x5a, 0x51, 0x1f, 0xfe,
