...
{
protected:
    services::Terminal::WithMaxQueueAndMaxBufferAndMaxHistory<> terminal{ communication, tracer };
};
...
{
protected:
    services::TerminalWithCommandsImpl::WithMaxQueueAndMaxBufferAndMaxHistory<> terminal{ communication, tracer };
