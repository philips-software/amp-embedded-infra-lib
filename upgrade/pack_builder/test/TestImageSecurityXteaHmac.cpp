...
public:
    ...
    const std::array<uint8_t, 16> xteaKey{ { 0xeb, 0x16, 0xab, 0x4f, 0xff, 0x4f, 0xa6, 0xdc,
...
TEST_F(TestImageSecurityXteaHmac, Secure)
{
    EXPECT_EQ((std::vector<uint8_t>{
                  ...
                  0x61, 0xcc, 0x0f, 0x69, 0xe3, 0xaa, 0x39, 0x85 }),
        encrypter.Secure(std::vector<uint8_t>{ 1, 2, 3, 4 }));
}
