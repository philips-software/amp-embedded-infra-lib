...
TEST_F(MaterialGeneratorTest, convert_key_256)
{
    ...
    auto aeskeyBinExpected = std::array<uint8_t, 16>{ { 0xf9, 0xe4, 0x39, 0x1f, 0x60, 0x80, 0x98, 0x85, 0x88, 0x6d, 0x44, 0x88, 0xc5, 0xf4, 0xb9, 0xf5 } };
    auto publicKeyBinExpected = std::array<uint8_t, 64>{ { 0x3e, 0x6b, 0xe0, 0x8c, 0x64, 0x3e, 0xf8, 0x26,
        0x3f, 0x9c, 0xdc, 0x7e, 0x75, 0x5d, 0x17, 0x04,
        0xf2, 0xfd, 0xe0, 0xf4, 0x0f, 0x35, 0xc3, 0x01,
        0x9d, 0x8b, 0x2b, 0xb1, 0xd2, 0x87, 0xdb, 0x5e,
        0x92, 0x9e, 0x87, 0x66, 0x59, 0x44, 0xb5, 0xb7,
        ...
        0x9d, 0xa2, 0x67, 0xf2, 0x7a, 0x27, 0xb4, 0x56,
        0x92, 0x11, 0x90, 0x2e, 0x54, 0x64, 0x31, 0x4c } };
    auto privateKeyBinExpected = std::array<uint8_t, 64>{ { 0xff, 0xd1, 0x3b, 0x3b, 0x7f, 0xb7, 0xf0, 0xd4,
        0x60, 0x29, 0x27, 0x0d, 0xc5, 0x7e, 0xa6, 0x75,
        0x2a, 0xbb, 0x2c, 0x98, 0xe9, 0xe2, 0x4c, 0xfa,
        0xb6, 0x34, 0x0a, 0xcb, 0x45, 0x99, 0xc0, 0x61,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    EXPECT_TRUE(infra::ContentsEqual(aeskeyBin, infra::MakeRange(aeskeyBinExpected)));
    EXPECT_TRUE(infra::ContentsEqual(publicKeyBin, infra::MakeRange(publicKeyBinExpected)));
    EXPECT_TRUE(infra::ContentsEqual(privateKeyBin, infra::MakeRange(privateKeyBinExpected)));
}
...
TEST_F(MaterialGeneratorTest, convert_key_224)
{
    ...
    auto aeskeyBinExpected = std::array<uint8_t, 16>{ { 0xf9, 0xe4, 0x39, 0x1f, 0x60, 0x80, 0x98, 0x85, 0x88, 0x6d, 0x44, 0x88, 0xc5, 0xf4, 0xb9, 0xf5 } };
    auto publicKeyBinExpected = std::array<uint8_t, 56>{ { 0x3e, 0x6b, 0xe0, 0x8c, 0x64, 0x3e, 0xf8, 0x26,
        0x3f, 0x9c, 0xdc, 0x7e, 0x75, 0x5d, 0x17, 0x04,
        0xf2, 0xfd, 0xe0, 0xf4, 0x0f, 0x35, 0xc3, 0x01,
        0x9d, 0x8b, 0x2b, 0xb1, 0xd2, 0x87, 0xdb, 0x5e,
        0x92, 0x9e, 0x87, 0x66, 0x59, 0x44, 0xb5, 0xb7,
        0xa5, 0xab, 0x7f, 0xbf, 0xe7, 0x8c, 0x8f, 0xee,
        0x92, 0x11, 0x90, 0x2e, 0x54, 0x64, 0x31, 0x4c } };
    auto privateKeyBinExpected = std::array<uint8_t, 56>{ { 0xff, 0xd1, 0x3b, 0x3b, 0x7f, 0xb7, 0xf0, 0xd4,
        0x60, 0x29, 0x27, 0x0d, 0xc5, 0x7e, 0xa6, 0x75,
        0x2a, 0xbb, 0x2c, 0x98, 0xe9, 0xe2, 0x4c, 0xfa,
        0xb6, 0x34, 0x0a, 0xcb, 0x45, 0x99, 0xc0, 0x61,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
